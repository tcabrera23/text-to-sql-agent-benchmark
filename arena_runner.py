...
Uso:
    python arena_runner.py --api-key TU_API_KEY [opciones]
...
Opciones:
    ...
    --output: Archivo de salida para resultados (default: arena_results.json)
...
from arena_tests import ARENA_TESTS, validate_result, get_tests_by_level
from metrics import log_metrics, calculate_cost, calculate_efficiency

# Configuración de modelos del Arena
ARENA_MODELS = {
    "heavyweight": {
        "name": "openai/gpt-4o",
...
def main():
    ...
    parser.add_argument("--output", default="arena_results.json", help="Archivo de salida")
